...
public class Workstation extends StacionaryComputer {
	...
	public Workstation(String nameOfOperatingSystem, int randomAccessMemory,
			int computerPrice, double processorSpeed, int powerSupplyUnit,
			int hardDiscSpace, int numberOfMonitors,
			int numberOfProcessingCores, boolean hasECC) {
