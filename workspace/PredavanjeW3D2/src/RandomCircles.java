...
public class RandomCircles extends JPanel implements ActionListener {
    ...
    public void drawFrame(Graphics g, int frameNumber, int width, int height) {
        ...
        for (count = 0; count < 500; count++) {
            ...
            g.fillOval( centerX - 50, centerY - 50, 150, 150 );
            g.setColor(Color.BLACK);
            g.drawOval( centerX - 50, centerY - 50, 150, 150 );
    ...
    public static void main(String[] args) {
         ...
         */
        drawingArea.setPreferredSize(new Dimension(1500,1500));
         ...
         */
        Timer frameTimer = new Timer(3,drawingArea);
